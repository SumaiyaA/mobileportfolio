...
var resizePizzas = function(size) {
    ...
    function changeSliderLabel(size) {
        switch (size) {
            case "1":
                //chage querySelector by getElementById method
    ...
    function changePizzaSizes(size) {
        ...
        var dx = determineDx(randomPizzaContainer[3], size);
        var newwidth = (randomPizzaContainer[3].offsetWidth + dx) + 'px';
...
// items and itemLength are global variable
var items;
var itemLength;
...
document.addEventListener('DOMContentLoaded',
    window.requestAnimationFrame(function() {
        ...
        for (var i = 0, elem; i < cols * rows; i++) {
            ...
            //move the height and width in style.css
